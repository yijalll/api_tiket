...
const { getPaket, createPaket, updatePaket, deletePaket, getPaketById, update_status, getStruk } = require("../controller/Paket");
const { verifyToken } = require("../middleware/VerifyToken");
const { route } = require("./route");

router.get("/paket", verifyToken, getPaket);
router.get("/paket/:id", verifyToken, getPaketById);
router.get("/struk/:id", verifyToken, getStruk);
